; (function (exports) {
    ...
    var calendarGenerators = {
        google: function (event) {
            ...
            return '<a style="display:block;color:white;padding:8px 30px;margin:0px" target="_blank" href="' +
                href + '">';
        },
    ...
    var generateMarkup = function (calendars, clazz, calendarId) {
        ...
        result.innerHTML = '<label id="add-to-calendar-label" for="checkbox-for-' +
            calendarId + '" class="btn btn-fill btn-small" style="padding:0px">' + calendars.google + '<i class="fa fa-calendar"></i>&nbsp;&nbsp; Lägg till i kalendern</a></label>';
